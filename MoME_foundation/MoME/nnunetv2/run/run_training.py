...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if isinstance(fold, str):
        if fold != 'all' and fold != 'MOE5experts_finetune_degeneration_plan1_segfree-1e-3_cllossl3V3' and fold != 'ISLES' and fold != 'OASIS' \
            and fold != 'BraTSflair' and fold != 'BraTSt2' and fold != 'TTCH' and fold != 'TTCADWI' and fold != 'T2andFlair2experts'\
                and fold != 'WMH2017flair' and fold != 'WMH2017t1' and fold != 'ISLES' and fold != 'OASIS' \
        and fold != 'TTtumor_flair' and fold != 'TTtumor_t2' and fold != 'BraTSt1ce' and fold != 'BraTSt1' and fold != 'ATLAS': 
            try:
                fold = int(fold)
